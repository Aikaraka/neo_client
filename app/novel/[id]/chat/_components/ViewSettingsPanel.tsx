...
import LeftAlignedIcon from "@/public/novel/chat/left-aligned.svg";
import CenterAlignedIcon from "@/public/novel/chat/center-aligned.svg";
...
export function ViewSettingsPanel({ onClose, onColorChange, selectedColor, fontSize, onFontSizeChange, lineHeight, onLineHeightChange, paragraphSpacing, onParagraphSpacingChange, paragraphWidth, onParagraphWidthChange, brightness, onBrightnessChange, align, onAlignChange }: {
  onClose: () => void,
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 16, padding: "0 24px 0 24px", minHeight: 48, position: "relative" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
          {paragraphWidth !== DEFAULT_PARAGRAPH_WIDTH && (
            <button
              onClick={() => onParagraphWidthChange(DEFAULT_PARAGRAPH_WIDTH)}
              style={{ background: "none", border: "none", padding: 0, marginRight: 4, cursor: "pointer", display: "flex", alignItems: "center" }}
              title="기본값으로 되돌리기"
            >
              <RefreshIcon style={{ width: 20, height: 20, color: "#858585" }} />
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 16, padding: "0 24px 0 24px", minHeight: 48, position: "relative" }}>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          ...
          >
            <LeftAlignedIcon style={{ color: align === "left" ? "#9125B1" : "#848C95" }} />
          </button>
          <button
          ...
          >
            <CenterAlignedIcon style={{ color: align === "center" ? "#9125B1" : "#848C95" }} />
          </button>
        </div>
      </div>
    </div>
